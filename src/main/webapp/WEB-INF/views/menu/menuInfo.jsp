...
<head>
	...
	<link href="<c:url value="/resources/menu/css/menuInfo.css?1"/>" rel="stylesheet" type="text/css">
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
	<script src="<c:url value="/resources/menu/js/menuInfo_script.js"/>"></script>
</head>
<body>
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<div class="detail-image">
				<img src="<c:url value="/resources/menu/img/${menu.menu_photo}" />">
			</div>
			<!--detail-image-->
