...
<script type="text/javascript" src="<c:url value="/resources/review/js/review.js"/>"></script>
<link href="<c:url value="/resources/review/css/review.css"/>" rel="stylesheet" type="text/css">
