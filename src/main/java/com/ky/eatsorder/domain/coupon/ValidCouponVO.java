...
public class ValidCouponVO {
	...
	public ValidCouponVO() {
		super();
	}

	public ValidCouponVO(String coupon_id, String coupon_name, String coupon_info, int available_price, int discount_amount,
