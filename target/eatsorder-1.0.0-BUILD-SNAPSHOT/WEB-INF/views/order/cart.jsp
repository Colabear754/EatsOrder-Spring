...
<div class="sticky">
	...
	<ul class="orderlist" id="orderlist_id">
		...
		<c:if test="${rst_id != 0}">
			<li><h5><a class="order1" id="rst-link" href="/EatsOrder/restaurant/rst_form.do">${rst_name}</a></h5></li>
		</c:if>
...
<link rel="stylesheet" href='<c:url value="/resources/order/css/cart.css" />'>
<script type="text/javascript" src='<c:url value="/resources/order/js/cart.js" />'></script>